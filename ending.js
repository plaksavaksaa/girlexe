...
function startRiddles() {
  container.innerHTML = "";
  showRiddle(
    "Ты не видишь их, пока не обернёшься. Что это?",
    ["следы", "камни", "монеты", "песок"],
    "следы",
    () => showRiddle(
      "Четыре конечности. Всегда рядом. Кто это?",
      ["волк", "стыд", "я", "кровать"],
      "стыд",
      () => showRiddle(
        "Сладкое. Все этого хотят. Но потом — становится тошно.",
        ["конфеты", "любовь", "девочка", "согласие"],
        "согласие",
